...
export class Rama {
    ...
    let escena2 = new Escena('Lego LAs emanpanadilla');
    let escena3_1 = new Escena('carretera Cáceres');
    let escena3_2 = new Escena('carretera Cáceres');
    let escena3_3 = new Escena('carretera Cáceres');
    let escena4 = new Escena('Amazon packet');
    
    boton1.rename("Botón 1");
