...
export class Rama {
  rama1 () {
    ...
    const escena1 = new Escena('El inicio de una Locura')
    const escena2 = new Escena('Comienza el viaje a Cáceres')
    const escena3_1 = new Escena('Un Troll y una foto en la carretera de Cáceres')
    const escena3_2 = new Escena('Un Troll y un rey en la carretera de Cáceres')
    const escena3_3 = new Escena('Un Troll, un rey y un arco en la carretera de Cáceres')
    const escena4 = new Escena('Amazon Mouse')
  ...
  rama2 () {
    // Crea varias instancias de la clase Escena para representar diferentes escenas en la aplicación o juego
    const escena1 = new Escena('El inicio de una Locura')
    const escena2 = new Escena('Viaje a Badajoz')
    const escena3_1 = new Escena('guardia civil')
    const escena3_2 = new Escena('Mariano Rajoy')
    const escena3_3 = new Escena('Pisa a un buen Conejo')
    const escena4 = new Escena('La piscina de los bomberos y legolas perdido')
  ...
  rama3 () {
    // Crea varias instancias de la clase Escena para representar diferentes escenas en la aplicación o juego
    const escena1 = new Escena('El inicio de una Locura')
    const escena2 = new Escena('Matar a El Arrebato')
    const escena3_1 = new Escena('Slenderman Enamorado de Bilbo')
    const escena3_2 = new Escena('Llegada al concierto')
    const escena3_3 = new Escena('Cansados')
    const escena4 = new Escena('Arrebato tiene mas entradas que el Bernabeu')
