...
export class Escena {
    ...
    #bilbo = new Personaje('Bilbo Bolsón', 'Hobbit');
    #gandalf = new Personaje('Gandalf El Gris', 'mayor');
    #kili = new Personaje('Kili');
    #fili = new Personaje('Fili');
    #legolas = new Personaje('legolas');
    #troll = new Troll('Troll');
    #rajoy = new Personaje('Mariano Rajoy')
    #reyTroll = new ReyTroll('Rey Troll');
    #mickeyMouse = new Personaje('Mickey Mouse');
    #dwalin = new Personaje('Dwalin');
    #guardiaCivil = new Personaje('Guardia Civil');
    #viajeroMisterioso = new Personaje('Viajero Misterioso');
    #elBasto = new Personaje('El Basto');
    #liebre = new Personaje('Liebre');
    ...
    this.#gandalf.hablar('SILENCIO, TODO EL MUNDO');
    this.#narrador.narrar('De repente, entra legolas muy nervioso.');
    this.#legolas.hablar('Esta pasando algo maloo , Ji JI JI Jaaaa');
...
escena3_3() {//buccle
    ...
    this.#narrador.narrar('legolas toma su arco y se prepara para disparar al Rey Troll. Si falla, tendrán que elegir otro camino.');
}
    ...
    this.#narrador.narrar('legolas era repartidor de Amazon y solo quería ayuda para pasar la autopista.');
}
...
escena2_2() {//decision
    ...
    this.#gandalf.hablar("Será hora de elegir el transporte: Olivenza, Valverde, Mérida.");
}
...
escena3_3_r2() {//bucle
    ...
    this.#elBasto.hablar("Las orejas para calcetines en invierno, vámonos.");
...
escena4_2() {//final
    ...
    this.#legolas.hablar("Para que no nos pillen, cada uno tendrá que esconder cada cosa como pueda en su ropa. Bilbo, tú llevarás el cargador con la bala, yo llevaré la mira y Gandalf, tú llevarás el arma plegada en tu vestido.");
}
escena3_2_r3() {//final
...
escena3_1_r3() {//directo
    ...
    this.#SeguridadPrivada.hablar("Buenas tardes chicos, depositen sus cosas en una bandeja.");
